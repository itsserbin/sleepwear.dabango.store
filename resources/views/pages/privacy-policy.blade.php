        ...
        <div class="row">
            <div class="col-12">
                <section>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">а) Сайт Владельца/ Сайт &mdash; интернет-сайт, размещенные в домене Владельца сайта и его поддоменах.</li>
                        <li class="list-group-item">б) Соглашение &mdash; настоящее соглашение со всеми дополнениями и изменениями.</li>
                        <li class="list-group-item">в) Администрация/представитель Сайта, Владельца Сайта &ndash; лицо уполномоченное Владельцем сайта на действия предусмотренные Соглашением.</li>
                        <li class="list-group-item">г) Посетитель - любое лицо, которое перешло на Сайт и находится на нем, используя его свойства для ознакомления с контентом размещенным на Сайте.</li>
                        <li class="list-group-item">д) Пользователь &mdash; дееспособное физическое лицо, присоединившееся к настоящему Соглашению в собственном интересе либо выступающее от имени и в интересах представляемого им юридического лица.</li>
                    </ul>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Предоставления Пользователю доступа к ресурсам Сайта и партнеров Сайта.</li>
                        <li class="list-group-item">Установления с Пользователем обратной связи, включая телефонный звонок, направление уведомлений, запросов, касающихся использования Сайта, оказания услуг, обработка запросов и заявок от Пользователя, направления рекламной и другой информации об акциях и других услугах Сайта.</li>
                        <li class="list-group-item">Определения места нахождения Пользователя для обеспечения безопасности, предотвращения мошенничества.</li>
                        <li class="list-group-item">Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.</li>
                        <li class="list-group-item">Предоставления Пользователю эффективной клиентской и технической поддержки при возникновении проблем связанных с использованием Сайта.</li>
                        <li class="list-group-item">Предоставления Пользователю обновлений услуг, специальных предложений, информации о ценах, новостной рассылки и иных сведений от имени Сайта или от имени партнеров Сайта.</li>
                        <li class="list-group-item">Осуществления рекламной деятельности Сайта.</li>
                        <li class="list-group-item">Предоставления доступа Пользователю на сайты или сервисы партнеров Сайта с целью получения продуктов, обновлений и услуг.&nbsp;</li>
                    </ul>
                    <h2>СОБИРАЕМАЯ ИНФОРМАЦИЯ ( Персональная информация)</h2>
                    <p>Мы собираем следующую информацию:&nbsp;</p>
                    <ul class="list-group">
                        <li class="list-group-item">Техническая информация, автоматически собираемая программным обеспечением Сайта во время его посещения.</li>
                        <li class="list-group-item">Персональная информация, предоставляемая Вами при заполнении соответствующей формы или информация получаемая Сайтом с использованием Пользователем социальных сетей.</li>
                    ...
                    <p>В целях заключения Договоров Пользователь также может предоставить следующие персональные данные о себе или об организации и её представителях в интересах которой он действует: имя, отчество, фамилия, должность, телефонный номер, дополнительно могут предоставляться наименование, корпоративные регистрационные данные (код предприятия, налоговый номер, адрес регистрации и почтовый адрес такой организации, корпоративный телефонный номер, расчетный счет, наименование обслуживающего банка, и корреспондентский счет и т.п.).Указанные сведения об организации не относятся к персональным данным.</p>
                    <h2>ОБЯЗАТЕЛЬСТВА СТОРОН&nbsp;</h2>
                    <p>Пользователь обязан:&nbsp;</p>
                    <ul class="list-group">
                        <li class="list-group-item">Предоставить информацию о персональных данных, необходимую для пользования Сайтом в рамках Пользовательского соглашения или заключения Договора.&nbsp;</li>
                        <li class="list-group-item">В случае заключения Договора с Владельцем Сайта обновить, дополнить предоставленную информацию о персональных данных в случае изменения данной информации.&nbsp;</li>
                    </ul>
                    <p>Администрация/представитель Сайта / Владелец сайта обязан:&nbsp;</p>
                    <ul class="list-group">
                        <li class="list-group-item">Использовать полученную информацию исключительно для целей, указанных в настоящей Политики конфиденциальности.&nbsp;</li>
                        <li class="list-group-item">Обеспечить хранение конфиденциальной информации, не разглашать без предварительного разрешения Пользователя, а также не осуществлять продажу, обмен, опубликование, либо разглашение иными возможными способами переданных персональных данных Пользователя. Персональные данные Пользователя могут храниться в сроки и/или быть переданы уполномоченным органам государственной власти только по основаниям и в порядке, установленным законодательством.&nbsp;</li>
                    </ul>
                    <ul class="list-group">
                        <li class="list-group-item">Принимать меры предосторожности для защиты конфиденциальности персональных данных Пользователя согласно порядку, обычно используемого для защиты такого рода информации в существующем деловом обороте.&nbsp;</li>
